...
class TestCalculator(unittest.TestCase):#unittest module provides a set of tools for constructing and running scripts, we will test features of online calculator in this case
	...
	def test_add8(self):
		...
		solution = self.app.get('/add?A=chaitu&B=22')
	...
	def test_add9(self):
		...
		solution = self.app.get('/add?A=22&B=marcherla')
		self.assertEqual(b'22.0', solution.data)
	...
	def test_sub1(self):
		#case 1, A is n integer B is an integer
		solution = self.app.get('/sub?A=8&B=2')
		self.assertEqual(b'6.0', solution.data)

	def test_sub2(self):

		#case 2, A is rational number and B is rational number p/q form
		solution = self.app.get('/sub?A=5/2&B=1/2')
		self.assertEqual(b'2.0', solution.data)
	...
	def test_sub4(self):
		...
		#case 4, when A is float and B is integer
		solution = self.app.get('/sub?A=24.222&B=2')
		self.assertEqual(b'22.222', solution.data)
	...
	def test_sub6(self):
		...
		#case 6, when A is fraction p/q and B is an integer
		solution = self.app.get('/sub?A=1/2&B=10')
		self.assertEqual(b'-9.5', solution.data)

	def test_sub7(self):

		#case 7, when A is an integer and B is a fraction p/q
		solution = self.app.get('/sub?A=5&B=2/10')
		self.assertEqual(b'4.8', solution.data)

	def test_sub8(self):

		#case 8, when A input is an alphabet(non integer) and B is integer
		solution = self.app.get('/sub?A=chaitu&B=10')
		self.assertEqual(b'-10.0', solution.data)#non integer type considered as not valid , in this case which is zero

	def test_sub9(self):

		#case 9, when A input is an integer and B input is an alphabet
		solution = self.app.get('/sub?A=22&B=macherla')
		self.assertEqual(b'22.0', solution.data)
		#when one input is alphabet and other input be any number, whether rational , integer, fraction ultimately the result will be the input which was an integer
	...
	def test_sub10(self):
		...
		#case 10, when A input is of the form p/q where q=0 and B input be any number
		solution = self.app.get('sub?A=5/0&B=2')
		self.assertEqual(b"None", solution.data)
	...
	def test_sub11(self):
		...
		#case 11, when A input is any number and B=p/q form where q=0
		solution = self.app.get('sub?A=12&B=4/0')
		self.assertEqual(b"None", solution.data)

	def test_mul1(self):
		#case 1, A is n integer B is an integer
		solution = self.app.get('/mul?A=15&B=2')
		self.assertEqual(b'30.0', solution.data)
	...
	def test_mul5(self):
		...
		#case 5, when A is integer and B is float
		solution = self.app.get('/mul?A=1000&B=7.79')
		self.assertEqual(b'7790.0', solution.data)
	...
	def test_mul10(self):
		...
		#case 10, when A input is of the form p/q where q=0 and B input be any number
		solution = self.app.get('mul?A=7/0&B=2')
		self.assertEqual(b"None", solution.data)
		#according to the script if q=0 in p/q form then it should display an error but it is resolved using zerodivision module
	...
	def test_mul11(self):
		...
		#case 11, when A input is any number and B=p/q form where q=0
		solution = self.app.get('mul?A=12&B=5/0')
		self.assertEqual(b"None", solution.data)
	...
	def test_div2(self):
		...
		#case 2, A is rational number and B is rational number p/q form
		solution = self.app.get('/div?A=7/2&B=15/5')
		self.assertEqual(b'1.1666666666666', solution.data)
	...
	def test_div5(self):
		...
		#case 5, when A is integer and B is float
		solution = self.app.get('/div?A=15&B=4.4')
		self.assertEqual(b'3.4090909090909', solution.data)

	def test_div6(self):

		#case 6, when A is fraction p/q and B is an integer
		solution = self.app.get('/div?A=16&B=100')
		self.assertEqual(b'0.16', solution.data)
	...
	def test_div8(self):
		...
		#case 8, when A input is an alphabet(non integer) and B is integer
		solution = self.app.get('/div?A=chaitu&B=12')
		self.assertEqual(b'0.0', solution.data)#non integer type considered as not valid , in this case which is zero

	def test_div9(self):

		#case 9, when A input is an integer and B input is an alphabet
		solution = self.app.get('/div?A=22&B=macherla')
		self.assertEqual(b'None', solution.data)
		#when one input is alphabet and other input be any number, whether rational , integer, fraction ultimately the result will be the input which was an integer
	...
	def test_div10(self):
		...
		#case 10, when A input is of the form p/q where q=0 and B input be any number
		solution = self.app.get('div?A=5/0&B=2')
		self.assertEqual(b'None', solution.data)
		#according to the script if q=0 in p/q form then it should display an error
	...
	def test_div11(self):
		...
		#case 11, when A input is any number and B=p/q form where q=0
		solution = self.app.get('div?A=12&B=9/0')
		self.assertEqual(b'None', solution.data)
